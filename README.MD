...
- To populate summary tables, helper scripts need to be run with cron -- one hourly, one daily (see cron.jobs file)
- Must export summary tables as CSV to the location specified in ICU
